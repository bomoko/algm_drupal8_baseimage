...
#	docker-compose exec cli php /app/web/core/scripts/run-tests.sh --browser --verbose --url http://drupal8.docker.amazee.io --sqlite ../var/www/html/results/simpletest.sqlite; \
